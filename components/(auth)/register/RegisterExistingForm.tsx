"use client";
import { regsiterExistingUser } from "@/actions/auth";
...
const RegisterExistingForm = ({ id }: { id: string }) => {
  const initialState = {
    message: "",
    errors: {},
  };

  const regsiterExistingUserWithId = regsiterExistingUser.bind(null, id);
  const [state, formAction, isPending] = useActionState(
    regsiterExistingUserWithId,
    initialState
  );
...
export default RegisterExistingForm;
