...
const MyReport = ({
  ...
  return (
    <div className="embla__slide__1 h-[210px] md:w-[80px] w-[90px]">
      <div className="relative embla__slide__number shadow-xl gap-4 flex flex-col w-[300px] md:w-[295px] h-[180px] bg-turquoise-100 rounded-2xl pl-2 md:pl-4 py-5 overflow-y-hidden">
